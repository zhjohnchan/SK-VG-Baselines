...
class Network(nn.Module):
    ...
    def _add_gt_image(self):
        ...
        image = Image.fromarray(image[0]).resize(size=(self._im_info[:2] / self._im_info[2],
                                                       self._im_info[:2] / self._im_info[2]))
    ...
    def _region_proposal(self, net_conv):
        ...
        rpn_cls_score_reshape = rpn_cls_score.reshape(1, 2, -1, rpn_cls_score.size()[-1])
