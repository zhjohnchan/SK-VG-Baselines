...
class REFER:
    ...
    def __init__(self, data_root, dataset='refcoco', splitBy='unc'):
        ...
        print
        'loading dataset %s into memory...' % dataset
        ...
        if dataset in ['refcoco', 'refcoco+', 'refcocog']:
            ...
            print
            'No refer dataset is called [%s]' % dataset
            sys.exit()
...
if __name__ == '__main__':
    ...
    print
    'There are %s training referred objects.' % len(ref_ids)
    ...
    for ref_id in ref_ids:
        ...
        pprint(ref)
        print
        'The label is %s.' % refer.Cats[ref['category_id']]
        plt.figure()
