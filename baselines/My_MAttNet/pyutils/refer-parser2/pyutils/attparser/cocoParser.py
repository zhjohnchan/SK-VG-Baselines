...
class CocoParser(BaseParser):
    ...
    def decompose(self):
        ...
        ForbiddenWds = list(self.config.size_table['words']) + \
                       list(self.config.color_table['words']) + \
                       list(self.config.position_table['words']) + \
                       list(self.config.location_table['words']) + \
                       list(self.config.ordinal_table['words'])
